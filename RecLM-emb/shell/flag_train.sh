...
torchrun --nproc_per_node 4 \
    ...
    --small_threshold 0 \
    --drop_threshold 0 \
    --output_dir /home/aiscuser/FlagEmbedding/1102_$version \
...
export TASK="xbox"
export OUT_DIR="output/infer_metric/test_1102-$version"

export MODEL_PATH_OR_NAME="/home/aiscuser/FlagEmbedding/1102_$version"
