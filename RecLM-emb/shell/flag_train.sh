...
torchrun --nproc_per_node 4 \
    ...
    --train_data /home/aiscuser/user2item_minedHN.jsonl \
        /home/aiscuser/item2item_minedHN.jsonl \
    ...
    --small_threshold 0 \
    --drop_threshold 0 \
    --output_dir /home/aiscuser/FlagEmbedding/1102_emb_v2 \
...
export TASK="xbox"
export OUT_DIR="output/infer_metric/test_1102-1500"

export MODEL_PATH_OR_NAME="/home/aiscuser/FlagEmbedding/1102_emb_v2"
