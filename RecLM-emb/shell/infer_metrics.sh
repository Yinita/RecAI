...
#     --user_embedding_prompt_path /home/aiscuser/XboxDiscoveryAI/llm_rec/simulater/output/model_toolcall_analysis/stage2_eval_8B_specific_v1_1028.jsonl \
#     --answer_file $OUT_DIR/stage2.jsonl \
